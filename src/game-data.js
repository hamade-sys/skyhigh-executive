...
window.SkyHigh.FINANCING = {
  ...
  // Base interest rate changes each quarter (economic cycle)
  // Index corresponds to round number
  baseRateByRound: [
    0.065, 0.070, 0.075, 0.072, 0.068, // Rounds 1-5
    0.060, 0.055, 0.048, 0.050, 0.055, // Rounds 6-10
    0.058, 0.062, 0.060, 0.055, 0.048, // Rounds 11-15
    0.042, 0.038, 0.035, 0.032, 0.030, // Rounds 16-20
  ],
